...
public final class SettingsHelper {
	...
	/**
	 * Clicks the "Reset to Default (200 WPM)" button — covers PR #1's reset
	 * behaviour, not just its styling. Scoped via the unique
	 * `.srt-reset-button` class for the same duplicate-id reason as above.
	 */
	public static void resetToDefault(WebDriver driver) {
		driver.get(Config.SETTINGS_URL);
		driver.findElement(By.cssSelector(".srt-reset-button")).click();

		new WebDriverWait(driver, Duration.ofSeconds(10))
				.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".notice-success")));
	}
